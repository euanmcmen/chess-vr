...
public partial class PieceMoveDataModel : RealtimeModel {
    ...
    public int sequenceId {
        get {
            return _sequenceIdProperty.value;
        }
        set {
            if (_sequenceIdProperty.value == value) return;
            _sequenceIdProperty.value = value;
            InvalidateReliableLength();
        }
    }
    ...
    private ReliableProperty<int> _sequenceIdProperty;
    ...
    public PieceMoveDataModel() : base(null) {
        ...
        _sequenceIdProperty = new ReliableProperty<int>(5, _sequenceId);
    }
    ...
    protected override void OnParentReplaced(RealtimeModel previousParent, RealtimeModel currentParent) {
        ...
        _sequenceIdProperty.UnsubscribeCallback();
    }
    ...
    protected override int WriteLength(StreamContext context) {
        ...
        length += _sequenceIdProperty.WriteLength(context);
        return length;
    }
    ...
    protected override void Write(WriteStream stream, StreamContext context) {
        ...
        writes |= _sequenceIdProperty.Write(stream, context);
    ...
    protected override void Read(ReadStream stream, StreamContext context) {
        ...
        while (stream.ReadNextPropertyID(out uint propertyID)) {
            ...
            switch (propertyID) {
                ...
                case (uint) PropertyID.SequenceId: {
                    changed = _sequenceIdProperty.Read(stream, context);
                    break;
                }
                default: {
                    stream.SkipProperty();
